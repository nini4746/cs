...
- [ ] [[linux-essentials]] - 파일 시스템 구조, 권한, 프로세스 관리, 시그널
...
- [ ] [[docker-internals]] - 이미지 레이어, namespace/cgroup → os/virtualization-and-containers 기반
- [ ] [[dockerfile-best-practices]] - 레이어 캐싱, 멀티스테이지 빌드, 이미지 크기
