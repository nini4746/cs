...
- [x] [[kubernetes-networking]] - Service/Ingress, DNS, 왜 네트워크가 k8s의 최난관인가

## 4. CI/CD

- [x] [[ci-cd-principles]] - 파이프라인 설계, 테스트 단계 배치, 캐싱
- [x] [[deployment-strategies]] - 롤링/블루그린/카나리, 롤백 설계
- [x] [[github-actions]] - 워크플로우 구조, 시크릿, 셀프호스티드 러너

## 5. 인프라

- [x] [[iac]] - Terraform 개념, 상태 관리, drift
- [x] [[cloud-basics]] - 컴퓨트/스토리지/네트워크 기본 블록, 요금이 나오는 구조
- [x] [[observability]] - 로그/메트릭/트레이스 3종, SLO/SLI → distributed-systems/와 연결
