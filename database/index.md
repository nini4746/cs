...
- [ ] [[btree-index]] - B+tree 구조, 클러스터드 vs 논클러스터드 → data-structures/b-trees 기반
- [ ] [[index-usage]] - 인덱스 타는 조건, 복합 인덱스 순서, 커버링 인덱스, EXPLAIN 읽기
- [ ] [[lsm-tree]] - LSM tree vs B+tree, RocksDB/Cassandra 계열의 선택
- [ ] [[full-text-search]] - 역색인, 분석 파이프라인, TF-IDF/BM25, 어휘 vs 의미 검색

## 4. 쿼리 처리

- [ ] [[query-execution]] - iterator 모델, hash join vs merge join vs nested loop
...
- [ ] [[schema-migration]] - expand-contract, 무중단 스키마 변경, 온라인 DDL, 백필
