...
- [ ] [[comparison-sorts]] - merge/quick/heap 정렬, 비교 정렬 하한 Ω(n log n) 증명
- [ ] [[linear-sorts]] - counting/radix/bucket, 비교 없이 하한 뚫는 법
...
- [ ] [[dp-fundamentals]] - 최적 부분 구조, 중복 부분 문제, top-down vs bottom-up
- [ ] [[dp-patterns]] - LCS, LIS, 배낭, 편집 거리, 구간 DP
- [ ] [[dp-optimization]] - 공간 압축, 비트마스크 DP

## 5. 그리디

- [ ] [[greedy]] - 그리디가 성립하는 조건 (교환 논증), 활동 선택, 허프만 코딩

## 6. 그래프

- [ ] [[graph-traversal]] - BFS/DFS, 위상 정렬, SCC
- [ ] [[shortest-paths]] - 다익스트라, 벨만-포드, 플로이드-워셜, 음수 간선
- [ ] [[mst]] - 크루스칼, 프림, cut property 증명
...
- [ ] [[p-vs-np]] - P, NP, NP-완전, 환원 → automata/complexity와 연결
