...
- [컴파일러](compilers/) - 렉싱, 파싱, AST, 바이트코드 VM, 최적화
- [계산 복잡도](complexity-theory/) - P/NP, 환원, 근사, 공간 복잡도
...
- [프로그래밍 언어](programming-languages/) - 개념, 패러다임, 타입, 메모리 모델
- [양자 컴퓨팅](quantum-computing/) - 큐빗, 게이트, Grover/Shor, 오류정정
- [보안](security/) - 암호화, 해싱, 취약점
- [신호 처리](signal-processing/) - 샘플링, 푸리에, FFT, 디지털 필터
